...
const BlogDetail = async ({ params }) => {
  ...
  return (
    <div className="">
      <div className="text-center bg-gray-800 rounded-md border-2 border-green-500 shadow-md px-4 py-2 mx-3 my-3">
        {blog?.imageUrl ? (
          <Image
            ...
            width="600"
            height="400"
            className="w-full h-[500px] mt-2 px-2 py-2 object-cover mb-2 rounded-sm"
          />
        ) : null}
